  ...
  return (
    <main className="min-h-screen bg-[#0B0F14] text-[#E6EAF2]">
      ...
      >
        ...
        <div>
          <Label htmlFor="email" className="text-[#E6EAF2]">
            Email
          </Label>
          <Input
            id="email"
        ...
        <div>
          <Label htmlFor="password" className="text-[#E6EAF2]">
            Password
          </Label>
          <Input
            id="password"
        ...
        <Button
          type="submit"
          className="w-full bg-[#4F7DFF] hover:bg-[#3D5FBF] text-white"
        >
          Sign In
        </Button>
          </form>
        ...
        <Link href="/signup" className="text-[#4F7DFF] hover:text-[#3D5FBF]">
          Sign up
        </Link>
          </p>
