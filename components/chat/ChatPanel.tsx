...
export default function ChatPanel() {
  ...
  const [escalationType, setEscalationType] = useState<'complaint' | 'suggestion'>('complaint');
  ...
  const handleEscalate = async () => {
    ...
    try {
      const escalationData = {
        ...
        description: escalationDescription || `Escalated from chat session. Last message: ${messages[messages.length - 1]?.content || 'N/A'}`,
      };
                ...
                <DialogContent className="sm:max-w-md">
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <Select value={escalationType} onValueChange={(value: 'complaint' | 'suggestion') => setEscalationType(value)}>
                        <SelectTrigger>
                          <SelectValue />
                        </SelectTrigger>
                        <SelectContent>
                          <SelectItem value="complaint">Submit as Complaint</SelectItem>
                          <SelectItem value="suggestion">Submit as Suggestion</SelectItem>
                        </SelectContent>
                      </Select>
                    </div>
                    ...
                    <div>
                      ...
                      <Select value={escalationPriority} onValueChange={(value: 'low' | 'medium' | 'high') => setEscalationPriority(value)}>
                        <SelectTrigger>
                          <SelectValue />
                        </SelectTrigger>
                        <SelectContent>
                    ...
                    <div className="flex gap-2 pt-2">
                      ...
                      <Button
                        ...
                        className="flex-1"
                      >
                        {isEscalating ? "Escalating..." : `Escalate as ${escalationType}`}
                      </Button>
                    </div>
                  </div>
                </DialogContent>
